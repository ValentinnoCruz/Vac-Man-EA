...
## Initialization of the arena and characters
arena = PacmanArena(SCREEN_W, SCREEN_H)
##Pac-Man character initialization
...
while playing:
    ...
    if arena.playing() != 0:
        ...
        elif arena.playing() == 2 or arena.ghost_count() >= 32 * 4:
